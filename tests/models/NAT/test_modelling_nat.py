...
#     # from transformers.models.NAT.modeling_nat import CONVNEXT_PRETRAINED_MODEL_ARCHIVE_LIST

# from . . . . src.transformers.models.NAT import NATForImageClassification
...
#         model = NATClassification.from_pretrained("facebook/convnext-tiny-224").to(torch_device)
...
model = NATForImageClassification()
model.to("cuda")
